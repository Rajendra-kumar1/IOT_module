...
char ssid[] = "Rajendra";  //SSID
char pass[] = "raju@1998";  //Password
//-----------------------------------//
...
//-------------ThingSpeak Details-----------------//
unsigned long myChannelField = 1644746; //Channel ID
const int ChannelField1 = 1; //for Humidity
const int ChannelField2 = 2; //for Temperature
const char * myWriteAPIKey = "LDCNV3ZCQJ2R0NW7"; //Your Write API Key
//-----------------------------------------------//
